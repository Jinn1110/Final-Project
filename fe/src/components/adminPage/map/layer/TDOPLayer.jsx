...
const TDOPLayer = ({ tracks, highlightedDevice }) => {
              ...
              <div className="p-5 font-sans text-sm text-white rounded-xl shadow-2xl bg-[#0f1419]/95 backdrop-blur-lg">
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-xs text-gray-400">TDOP</div>
                ...
                <div className="text-xs text-gray-500 leading-relaxed">
                  <strong>TDOP</strong> (Time Dilution of Precision) đo lường độ
                  loãng hình học ảnh hưởng đến độ chính xác thời gian của
                  receiver.
                  <br />
                  <br />
                  Giá trị càng thấp → đồng bộ thời gian càng chính xác.
                  <br />
